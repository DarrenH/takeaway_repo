		...
		<div class="container-fluid">
			...
			<section id="main" class="row-fluid">
				<div id="items" class="span12">
					<h1>Sorry to see you changed your mind. Your order has not been placed</h1>
					<div id="holder">
						<div class="alert alert-error">You cancelled you order by not paying.</div>
						<p>If you have any comments on the site or our service please use our <a href="#contModal" class="btn btn-link" role="button" data-toggle="modal" data-loading-text="Please Wait..." data-target="#contModal" title="Contact Us">online contact service</a>.</p>
